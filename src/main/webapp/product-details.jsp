                                    ...
                                    <div class="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                ...
                                                <p class="text-dark">Good,but overpriced </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="border border-primary rounded position-relative vesitable-item">
                                ...
                                <div class="p-4 pb-0 rounded-bottom">
                                    ...
                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                        ...
                                        <a href="#" class="btn border border-secondary rounded-pill px-3 py-1 mb-4 text-primary" onclick="event.preventDefault(); addToCart('${p.id}', '${sessionScope.user.id}')"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                    </div>
                                </div>
                            </div>
